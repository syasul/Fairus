...
<div class="flex">
    ...
    <div class="relative w-full flex flex-col h-screen overflow-y-hidden">
        ...
        <div class="w-full h-screen overflow-x-hidden border-t flex flex-col">
            <main class="w-full flex-grow p-6">
                ...
                <div class="w-full mt-6">
                    <div class="flex justify-between mb-5">
                        ...
                        <button data-modal-toggle="add-rumah-modal"
                            ...
                            <tbody class="text-gray-700">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center py-3 px-4 flex justify-center">
                                        <img src="{{ asset('storage/Home/' . $rumah->gambar_rumah) }}" alt="Rumah Image"
                                            class="w-20 h-20 object-cover text-center rounded-lg">
                                    </td>
                                    ...
                                    <td class="text-center py-3 px-4">
                                        <div class="flex items-center justify-center gap-3">
                                            <button data-modal-toggle="edit-rumah-modal-{{ $rumah->id_rumah }}"
                                                class="bg-yellow-500 text-white px-2 py-1 rounded-lg">
                                                <i class="ri-edit-line"></i>
                                            </button>
                                            <button data-modal-toggle="delete-rumah-modal-{{ $rumah->id_rumah }}"
            ...
            <!-- Add Rumah Modal -->
            <div id="add-rumah-modal" aria-hidden="true"
                    ...
                    <div class="bg-white rounded-lg shadow relative">
                        <div class="flex justify-between items-center p-4 border-b">
                            ...
                            <button type="button"
                                ...
                                data-modal-toggle="add-rumah-modal">
                                <i class="ri-close-line"></i>
                            </button>
                        </div>
                        <form class="space-y-6 px-6 lg:px-8 pb-4 sm:pb-6 xl:pb-8"
                            action="{{ route('master-rumah.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div>
                                <label for="gambar_rumah" class="text-sm font-medium text-gray-900 block mb-2">Image
                                    Rumah</label>
                                <input type="file" name="gambar_rumah" id="gambar_rumah"
                            ...
                            <div>
                                <label for="tipe" class="text-sm font-medium text-gray-900 block mb-2">Tipe
                                    Rumah</label>
                                <input type="text" name="tipe" id="tipe"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg block w-full p-2.5"
                                    placeholder="Tipe Rumah" required>
                            </div>
                            ...
                            <div>
                                ...
                                <textarea name="deskripsi" id="deskripsi"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg block w-full p-2.5"
                                    placeholder="Deskripsi Rumah" required></textarea>
                            </div>
            ...
            <!-- Edit Rumah Modal -->
            @foreach ($rumahs as $rumah)
            <div id="edit-rumah-modal-{{ $rumah->id_rumah }}" aria-hidden="true"
                class="hidden overflow-x-hidden overflow-y-auto fixed h-modal md:h-full top-4 left-0 right-0 md:inset-0 z-50 justify-center items-center">
                <div class="relative w-full max-w-md px-4 h-full md:h-auto">
                    <div class="bg-white rounded-lg shadow relative">
                        <div class="flex justify-between items-center p-4 border-b">
                            ...
                            <button type="button"
                                class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center"
                                data-modal-toggle="edit-rumah-modal-{{ $rumah->id_rumah }}">
                                <i class="ri-close-line"></i>
                            </button>
                        </div>
                        <form class="space-y-6 px-6 lg:px-8 pb-4 sm:pb-6 xl:pb-8"
                            action="{{ route('master-rumah.update', $rumah->id_rumah) }}" method="POST"
                            ...
                            <div>
                                ...
                                <select name="id_perumahan" id="perumahan"
                                    ...
                                    <option value="{{ $perumahan->id_perumahan }}" {{ $perumahan->id_perumahan ==
                                        $rumah->id_perumahan ? 'selected' : '' }}>{{ $perumahan->nama_perumahan }}
                                    </option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div>
                                <label for="tipe" class="text-sm font-medium text-gray-900 block mb-2">Tipe
                                    Rumah</label>
                                <input type="text" name="tipe" id="tipe" value="{{ $rumah->tipe }}"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg block w-full p-2.5"
                                    required>
                            </div>
                            ...
                            <div>
                                ...
                                <textarea name="deskripsi" id="deskripsi"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg block w-full p-2.5"
                                    required>{{ $rumah->deskripsi }}</textarea>
                            </div>
            ...
            <!-- Delete Rumah Modal -->
            @foreach ($rumahs as $rumah)
            <div id="delete-rumah-modal-{{ $rumah->id_rumah }}" aria-hidden="true"
                class="hidden overflow-x-hidden overflow-y-auto fixed h-modal md:h-full top-4 left-0 right-0 md:inset-0 z-50 justify-center items-center">
                <div class="relative w-full max-w-md px-4 h-full md:h-auto">
                    <div class="bg-white rounded-lg shadow relative ">
                        <div class="flex justify-between items-center p-4 border-b">
                            ...
                            <button type="button"
                                class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center"
                                data-modal-toggle="delete-rumah-modal-{{ $rumah->id_rumah }}">
                                <i class="ri-close-line"></i>
                            </button>
                        </div>
