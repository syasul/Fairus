...
<div class="flex">
                            ...
                            <tbody class="text-gray-700">
                                ...
                                <tr>
                                    ...
                                    <td class="text-center py-3 px-4 flex justify-center">
                                        <img src="{{ asset('storage/Perumahan/' . $perumahan->gambar_perumahan) }}" alt="Perumahan Image" class="w-20 h-20 object-cover rounded-lg">
                                    ...
                                    <td class="text-center py-3 px-4">
                                        <div class="flex items-center justify-center gap-3">
                                            <button data-modal-toggle="edit-perumahan-modal-{{ $perumahan->id_perumahan }}"
                                                class="bg-yellow-500 text-white px-2 py-1 rounded-lg">
                                                <i class="ri-edit-line"></i>
                                            </button>
                                            <button data-modal-toggle="delete-perumahan-modal-{{ $perumahan->id_perumahan }}"
    ...
    class="hidden overflow-x-hidden overflow-y-auto fixed inset-0 z-50 flex items-center justify-center bg-gray-900 bg-opacity-50">
   <div class="relative w-full max-w-4xl bg-white rounded-lg shadow-lg overflow-y-auto max-h-screen">
       ...
       <div class="p-6 space-y-6">
           <form action="{{ route('master-perumahan.store') }}" method="POST" enctype="multipart/form-data">
               ...
               <div class="mb-4">
                   ...
                   <input type="text" name="nama_perumahan" class="mt-1 px-3 py-2 block w-full border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500" required>
               </div>
               <div class="mb-4">
                   <label for="deskripsi_singkat" class="block text-gray-700">Deskripsi Singkat</label>
                   <textarea name="deskripsi_singkat" class="mt-1 block w-full border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500" required rows="4"></textarea>
               </div>
               <div class="mb-4">
                   <label for="gambar_perumahan" class="block text-gray-700">Gambar Perumahan</label>
                   <input type="file" name="gambar_perumahan" class="mt-1 block w-full border border-gray-300 rounded-lg shadow-sm">
               </div>
               <div class="mb-4">
                   <label for="gambar_jumbotron" class="block text-gray-700">Gambar Jumbotron</label>
                   <input type="file" name="gambar_jumbotron" class="mt-1 block w-full border border-gray-300 rounded-lg shadow-sm">
               </div>
               <div class="mb-4">
                   <label for="about_perumahan_sub_title" class="block text-gray-700">About Perumahan Subtitle</label>
                   <input type="text" name="about_perumahan_sub_title" class="mt-1 px-3 py-2 block w-full border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500" required>
               </div>
               <div class="mb-4">
                   <label for="about_perumahan_content" class="block text-gray-700">About Perumahan Content</label>
                   <textarea name="about_perumahan_content" class="mt-1 block w-full border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500" required rows="4"></textarea>
               </div>
               <div class="mb-4">
                   <label for="about_perumahan_image" class="block text-gray-700">About Perumahan Image</label>
                   <input type="file" name="about_perumahan_image" class="mt-1 block w-full border border-gray-300 rounded-lg shadow-sm">
               </div>
               <div class="mb-4">
                   <label for="alasan_perumahan_content" class="block text-gray-700">Alasan Perumahan Content</label>
                   <textarea name="alasan_perumahan_content" class="mt-1 block w-full border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500" required rows="4"></textarea>
               </div>
               <div class="mb-4">
                   <label for="about_perumahan_image1" class="block text-gray-700">About Perumahan Image 1</label>
                   <input type="file" name="about_perumahan_image1" class="mt-1 block w-full border border-gray-300 rounded-lg shadow-sm">
               </div>
               <div class="mb-4">
                   <label for="about_perumahan_image2" class="block text-gray-700">About Perumahan Image 2</label>
                   <input type="file" name="about_perumahan_image2" class="mt-1 block w-full border border-gray-300 rounded-lg shadow-sm">
               </div>
               <div class="mb-4">
                   <label for="fasilitas_perumahan_title" class="block text-gray-700">Fasilitas Perumahan Title</label>
                   <input type="text" name="fasilitas_perumahan_title" class="mt-1 px-3 py-2 block w-full border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500" required>
               </div>
               <div class="mb-4">
                   <label for="maps_perumahan_sub_title" class="block text-gray-700">Maps Perumahan Subtitle</label>
                   <input type="text" name="maps_perumahan_sub_title" class="mt-1 px-3 py-2 block w-full border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500" required>
               </div>
               <div class="mb-4">
                   <label for="maps_perumahan_content" class="block text-gray-700">Maps Perumahan Content</label>
                   <textarea name="maps_perumahan_content" class="mt-1 block w-full border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500" required rows="4"></textarea>
               </div>
               <div class="mb-4">
                   <label for="maps_perumahan_image" class="block text-gray-700">Maps Perumahan Image</label>
                   <input type="file" name="maps_perumahan_image" class="mt-1 block w-full border border-gray-300 rounded-lg shadow-sm">
               </div>
               <div class="mb-4">
                   <label for="pembayaran_perumahan_title" class="block text-gray-700">Pembayaran Perumahan Title</label>
                   <input type="text" name="pembayaran_perumahan_title" class="mt-1 px-3 py-2 block w-full border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500" required>
               </div>
               <div class="mb-4">
                   <label for="pembayaran_perumahan_content" class="block text-gray-700">Pembayaran Perumahan Content</label>
                   <textarea name="pembayaran_perumahan_content" class="mt-1 block w-full border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500" required rows="4"></textarea>
               </div>
               <div class="mb-4">
                   <label for="penghargaan_title" class="block text-gray-700">Penghargaan Title</label>
                   <input type="text" name="penghargaan_title" class="mt-1 px-3 py-2 block w-full border border-gray-300 rounded-lg shadow-sm focus:ring-blue-500 focus:border-blue-500" required>
               </div>
               <div class="mb-4">
    ...
    <div id="edit-perumahan-modal-{{ $perumahan->id_perumahan }}" tabindex="-1" aria-hidden="true"
       ...
       <div class="relative w-full max-w-2xl bg-white rounded-lg shadow-lg">
           ...
           <div class="p-6 max-h-[70vh] overflow-y-auto">
               <form action="{{ route('master-perumahan.update', $perumahan->id_perumahan) }}" method="POST" enctype="multipart/form-data">
                   @csrf
                   @method('PUT')
                   ...
                   <!-- About Perumahan -->
                   <div class="mb-4">
                       <label for="about_perumahan_title" class="block text-gray-700 font-medium">Judul About Perumahan</label>
                   ...
                   <div class="mb-4">
                       <label for="about_perumahan_sub_title" class="block text-gray-700 font-medium">Sub Judul About Perumahan</label>
                   ...
                   <div class="mb-4">
                       <label for="about_perumahan_content" class="block text-gray-700 font-medium">Konten About Perumahan</label>
                   ...
                   <div class="mb-4">
                       <label for="about_perumahan_image" class="block text-gray-700 font-medium">Gambar About Perumahan</label>
                   ...
                   <div class="mb-4">
                       <label for="alasan_perumahan_content" class="block text-gray-700 font-medium">Alasan Perumahan Konten</label>
                   ...
                   <div class="mb-4">
                       <label for="about_perumahan_image1" class="block text-gray-700 font-medium">Gambar About Perumahan 1</label>
                   ...
                   <div class="mb-4">
                       <label for="about_perumahan_image2" class="block text-gray-700 font-medium">Gambar About Perumahan 2</label>
                   ...
                   <div class="mb-4">
                       <label for="fasilitas_perumahan_title" class="block text-gray-700 font-medium">Judul Fasilitas Perumahan</label>
                       ...
                       @foreach($fasilitas as $fasilitasItem)
                           <div class="flex items-center mb-2">
                               <input type="checkbox" name="fasilitas[]" value="{{ $fasilitasItem->id_fasilitas }}" {{
                                   in_array($fasilitasItem->id_fasilitas, $perumahan->fasilitas->pluck('id_fasilitas')->toArray()) ? 'checked' : '' }}
                                   class="mr-2">
                   ...
                   <div class="mb-4">
                       <label for="maps_perumahan_sub_title" class="block text-gray-700 font-medium">Sub Judul Maps Perumahan</label>
                   ...
                   <div class="mb-4">
                       <label for="maps_perumahan_content" class="block text-gray-700 font-medium">Konten Maps Perumahan</label>
                   ...
                   <div class="mb-4">
                       <label for="maps_perumahan_image" class="block text-gray-700 font-medium">Gambar Maps Perumahan</label>
                   ...
                   <div class="mb-4">
                       <label for="pembayaran_perumahan_title" class="block text-gray-700 font-medium">Judul Pembayaran Perumahan</label>
                   ...
                   <div class="mb-4">
                       <label for="pembayaran_perumahan_content" class="block text-gray-700 font-medium">Konten Pembayaran Perumahan</label>
    ...
    <div id="delete-perumahan-modal-{{ $perumahan->id_perumahan }}" aria-hidden="true" class="fixed hidden inset-0 flex items-center justify-center z-50 overflow-y-auto bg-gray-800 bg-opacity-50">
        <div class="relative w-full max-w-lg mx-4 md:mx-0 bg-white rounded-lg shadow-lg">
            <div class="flex justify-between items-center p-4 border-b border-gray-200">
                <h3 class="text-lg font-semibold text-gray-900">
                    Delete Perumahan
                </h3>
                <button type="button" class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg p-1.5 ml-auto inline-flex items-center" data-modal-toggle="delete-perumahan-modal-{{ $perumahan->id_perumahan }}">
                    <i class="ri-close-line"></i>
                    <span class="sr-only">Close modal</span>
                </button>
            </div>
            <form class="p-6 space-y-4" action="{{ route('master-perumahan.destroy', $perumahan->id_perumahan) }}" method="POST">
                @csrf
                @method('DELETE')
                <p class="text-sm text-gray-600">Are you sure you want to delete this perumahan?</p>
                <div class="flex justify-center">
                    <button type="submit" class="px-4 py-2 text-white bg-red-500 hover:bg-red-600 rounded-lg font-medium text-sm">
                        Delete
                    </button>
                </div>
            </form>
